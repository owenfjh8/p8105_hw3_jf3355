...
```
The dataset has `r ncol(accel_df)` variables, and `r nrow(accel_df)` observations. Each observation is about the activity counts for a specific minute from a 24-hour day and the information about that day, including the week, day_id, and whether it is a weekday or weekend.
